...
from classify_paper import DUMMY_API_KEY  # noqa: E402  (이 폴더의 버전 — 자체 서버용)
...
DEFAULT_RAW_OUTPUT = GOLDEN_NEW_DIR / "repeat_eval_raw.csv"
DEFAULT_SUMMARY_OUTPUT = GOLDEN_NEW_DIR / "repeat_eval_summary.csv"
